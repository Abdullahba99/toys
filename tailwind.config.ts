  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Spacetoon custom colors
        lilia: {
          DEFAULT: "hsl(var(--lilia) / <alpha-value>)",
          light: "hsl(var(--lilia-light) / <alpha-value>)",
          dark: "hsl(var(--lilia-dark) / <alpha-value>)",
        },
        adam: {
          DEFAULT: "hsl(var(--adam) / <alpha-value>)",
